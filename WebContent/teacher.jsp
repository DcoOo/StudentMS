    ...
    <div class="row-fluid">
        ...
        <div class="col-md-2" style="margin: 0 3px">
            <div class="row">
                ...
                <div class="col-md-3">
                    <a onclick="customize()">编辑</a>
                </div>
            </div>

            <form action="" method="post">
                <div class="row">
                    <div class="col-md-10 task">任务1</div>
                    <input type="hidden" value="" name="taskId[]" class="id">
                    <input type="text" value="" name="myTask[]" class="myTask" style="display: none">
                    <div class="col-md-1 sign"><a><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></a></div>
                </div>

                <div class="row">
                    <div class="col-md-10 task">任务2</div>
                    <input type="hidden" value="" name="taskId[]" class="id">
                    <input type="text" value="" name="myTask[]" class="myTask" style="display: none">
                    <div class="col-md-1 sign"><a><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></a></div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-10 task">任务3</div>
                    <input type="hidden" value="" name="taskId[]" class="id">
                    <input type="text" value="" name="myTask[]" class="myTask" style="display: none">
                    <div class="col-md-1 sign"><a><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></a></div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-10 task">任务4</div>
                    <input type="hidden" value="" name="taskId[]" class="id">
                    <input type="text" value="" name="myTask[]" class="myTask" style="display: none">
                    <div class="col-md-1 sign"><a><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></a></div>
                </div>
                <div id="input" style="display: none">
                    ...
                    <div id="addTaskDiv" style="display: none">
                        ...
                        <div id="InputsWrapper">
                            <div>
                                <input type="text" name="myTask[]" id="field_1" value=""/><a href="#" class="removeclass">×</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
                ...
                function check() {
                    ...
                    $.getJSON("./alpha/studentms/controller/TeacherSearchAllStudentsRegisterController",function(data){
                        checkArr = data;
                    });
                }
                function getCheck() {
                    ...
                    if ($('#rowCheck').length <= 0){
                        ...
                        content.append('<div class="row" id="rowCheck">' +
                            ...
                            '<form method=post action="./alpha/studentms/controller/TeacherOutputRegisterController">'+
                ...
                function getInfo() {
                    $.ajaxSettings.async = false;
                    $.getJSON("./alpha/studentms/controller/TeacherSearchAllStudentsController",function(data){
                        infos = data;
                    });
                }
                ...
                function allInfo() {
                    ...
                    content.append('<div id="rowInfo">' +
                        '<form action="./alpha/studentms/controller/TeacherOutputStudentInfoController" method="post" id="InfoForm">' +
