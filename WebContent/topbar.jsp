    ...
    <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a href="/StudentMS/servlet/showReplyedController">回复的帖子<span class="badge"></span></a></li>
                <li><a href="/StudentMS/servlet/showSendedPostController">发过的帖子<span class="badge"></span></a></li>
